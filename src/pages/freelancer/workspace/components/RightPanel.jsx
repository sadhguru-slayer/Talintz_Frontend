      ...
      {isOpen && !isMaximized && (
        ...
        >
          ...
          >
            <div
              className={`
                w-96 bg-freelancer-bg-grey/95 backdrop-blur-sm
                border border-freelancer-border rounded-xl shadow-2xl
            ...
            >
              ...
              <div 
                className="panel-handle flex items-center justify-between px-3 py-2 
                         border-b border-freelancer-border bg-freelancer-primary/40 
