...
const LeftSider = ({ collapsed, setCollapsed, activeSection, setActiveSection }) => {
  ...
  return (
    <motion.div 
      className="flex flex-col h-full bg-freelancer-bg-grey z-10 relative"
      initial={{ width: 200 }}
    ...
    >
      ...
      <div className="py-2 space-y-1 overflow-y-auto">
        {navItems.map(item => (
          <Tooltip
            ...
            overlayStyle={{ 
              maxWidth: 'none',
              background: 'var(--freelancer-bg-grey)',
              color: 'white',
              borderRadius: '8px',
              fontSize: '14px'
            }}
            ...
            >
              <Badge 
                ...
                style={{ 
                  ...
                  backgroundColor: activeSection === item.key ? 'var(--freelancer-accent)' : 'var(--freelancer-bg-grey)',
                  boxShadow: `0 0 0 2px var(--freelancer-bg-grey)`
                }}
              >
                <div 
      ...
      {/* Settings Button */}
      <div className="mt-auto p-2 border-t border-freelancer-border">
        <Tooltip
        ...
        >
          <motion.div
            ...
            className={`
              ...
              text-white/80 hover:text-white transition-all
              hover:bg-white/5
              ${activeSection === 'settings' ? 'bg-freelancer-accent/10' : ''}
            `}
          >
      ...
      <motion.button
        ...
        className="absolute top-1/2 -right-3 transform -translate-y-1/2
                   w-6 h-6 rounded-full bg-freelancer-bg-grey
                   flex items-center justify-center
                   text-white/60 hover:text-white
                   shadow-lg border border-freelancer-border
