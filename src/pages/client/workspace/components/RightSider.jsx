          ...
          >
            <motion.div
              ...
              className={`
                ...
                ${activePanelType === item.key ? 'bg-client-accent/10' : 'hover:bg-white/5'}
              `}
            >
              <Badge 
                count={item.badge} 
                offset={[-6, 4]}
                style={{ 
                  backgroundColor: item.key === 'chat' && activePanelType === 'chat' ? 'var(--client-accent)' : 'var(--client-primary)',
                  boxShadow: `0 0 0 2px var(--client-primary)`
                }}
              >
                <div 
