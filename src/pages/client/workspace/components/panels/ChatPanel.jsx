...
<div className="flex items-center justify-between px-4 py-3 border-b border-client-border bg-client-primary/40">
  <div className="flex items-center gap-2">
    ...
    <h3 className="text-sm font-semibold text-white">Project Chat</h3>
              ...
              <div className={`rounded-lg px-3 py-1 max-w-[80%] text-xs ${
                message.type === "text" 
                  ? message.userId === chatData.currentUser.id
                    ...
                    : 'bg-client-primary/40 text-white/90'
                  : ''
              }`}>
      ...
      {/* Message Input */}
      <div className="px-3 py-2 border-t border-client-border bg-client-primary/20">
        <div className="flex items-end gap-2">
          <div className="flex-1 bg-client-primary/40 rounded-lg border border-client-border">
            <textarea
              value={message}
            ...
            />
            <div className="flex items-center justify-between px-2 py-1 border-t border-client-border">
          ...
          <button 
            className="p-2 rounded-lg bg-client-accent text-white hover:bg-client-accent/90 transition-colors"
          >
            <SendOutlined />
          </button>
        </div>
