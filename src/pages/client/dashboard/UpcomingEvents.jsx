...
const ClientUpcomingEvents = () => {
  ...
  return (
    <div className="p-8 bg-client-bg min-h-screen">
      {/* Header */}
      <motion.div
        ...
        className="mb-8"
      >
        <h2 className="text-2xl font-semibold text-client-primary mb-2">Upcoming Events</h2>
        <p className="text-text-secondary">Manage your schedule and important deadlines</p>
      </motion.div>

      {/* Calendar Container */}
      <div className="calendar-container bg-client-bg-card rounded-xl shadow-md border border-client-border overflow-hidden mb-8">
        <FullCalendar
          ...
          eventContent={(eventInfo) => ({
            html: `
              <div class="event-content ${getEventTypeColor(eventInfo.event.extendedProps.type)} shadow-sm">
      ...
      <div className="mt-8">
        <div className="flex flex-col sm:flex-row items-center justify-between mb-6">
          <h3 className="text-xl font-semibold text-client-primary flex items-center gap-2 mb-4 sm:mb-0">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all
                ${eventType === type.value 
                  ? 'bg-client-primary text-text-light shadow-md' 
                  : 'bg-client-bg-card text-text-secondary hover:bg-client-bg-dark'}`}
            >
              {type.icon}
              ...
              <Badge 
                ...
                style={{ 
                  backgroundColor: eventType === type.value ? '#fff' : '#D3D3D3',
                  color: eventType === type.value ? '#1A365D' : '#4A5568',
                  minWidth: '20px',
                  height: '20px',
                  borderRadius: '10px',
                  padding: '0 6px',
          ...
          <AnimatePresence>
            {(events[eventType] || []).map((event, index) => (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0, y: -20 }}
                className="bg-client-bg-card rounded-lg border border-client-border overflow-hidden shadow-sm"
              >
                <div
        ...
        {/* Desktop View */}
        <div className="hidden md:block bg-client-bg-card rounded-lg shadow-md overflow-hidden border border-client-border">
          <Table
      ...
      <style jsx>{`
        ...
        .calendar-container .fc-toolbar {
          padding: 1.5rem;
          background: linear-gradient(to right, rgba(26, 54, 93, 0.03), rgba(26, 54, 93, 0.08));
        }
...
export default ClientUpcomingEvents;